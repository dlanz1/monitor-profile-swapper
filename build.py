...
def main():
    ...
    run_command("pyinstaller --noconfirm --onefile --windowed --name MonitorSwapper --hidden-import=pyautogui --hidden-import=pystray --hidden-import=PIL --hidden-import=win32com.client monitor_swapper.py")
